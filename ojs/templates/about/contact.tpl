...
<div class="arrow_down_box"><h3>{translate key="common.mailingAddress"}</h3></div>
<p>
...
<div class="arrow_down_box"><h3>{translate key="about.contact.principalContact"}</h3></div>
<p>
...
<div class="arrow_down_box"><h3>{translate key="about.contact.supportContact"}</h3></div>
<p>
