...
<div id="publisher">
<div class="arrow_down_box"><h3>{translate key="common.publisher"}</h3></div>
...
<div id="sponsors">
<div class="arrow_down_box"><h3>{translate key="about.sponsors"}</h3></div>
...
<div id="contributors">
<div class="arrow_down_box"><h3>{translate key="about.contributors"}</h3></div>
