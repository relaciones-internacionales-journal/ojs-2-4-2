...
{else}
	<tr>
		<td align="left" class="table_results_pagination">{page_info iterator=$categories}</td>
		<td align="right" class="table_results_pagination">{page_links anchor="categories" name="categories" iterator=$categories}</td>
	</tr>
{/if}
</table>

<a href="{url op="createCategory"}" class="action crear_general">{translate key="admin.categories.create"}</a>
</div>
