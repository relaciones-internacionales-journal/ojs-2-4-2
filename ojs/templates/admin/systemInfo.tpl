...
{if $latestVersionInfo}
	...
	{/if}
{else}
<p><a href="{url versionCheck=1}" class="buscar_general">{translate key="admin.version.checkForUpdates"}</a></p>
{/if}
</div><hr/>
...
<a href="{url op="phpinfo"}" target="_blank" class="info_general">{translate key="admin.phpInfo"}</a>
</div>
