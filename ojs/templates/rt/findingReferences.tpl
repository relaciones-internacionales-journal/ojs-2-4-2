...
<table width="100%" class="data_alt">
	<tr valign="top">
		...
		<td class="value" width="80%"><input name="author" id="author" type="text" size="20" maxlength="40" class="textField input-xxlarge" value="{$article->getAuthorString()|escape}" /></td>
	</tr>
	<tr valign="top">
		<td class="label"><label for="title">{translate key="article.title"}</label></td>
		<td class="value"><input type="text" id="title" name="title" size="40" maxlength="40" class="textField input-xxlarge" value="{$article->getLocalizedTitle()|escape}" /></td>
	</tr>
</table>
