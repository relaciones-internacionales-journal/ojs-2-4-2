...
{iterate from=journals item=journal}
	...
	<p>	
	{if $journal->getId() == "2"}
		<a href="http://www.relacionesinternacionales.info/ojs/index.html" class="action">{translate key="site.journalView"}WOPS</a> | <a href="http://www.relacionesinternacionales.info/ojs/issue/current.html" class="action">{translate key="site.journalCurrent"}WOPS</a> | <a href="http://www.relacionesinternacionales.info/ojs/user/register.html" class="action">{translate key="site.journalRegister"}WOPS</a>
	{else}
	<a href="{url journal=$journal->getPath()}" class="action">{translate key="site.journalView"}</a> | <a href="{url journal=$journal->getPath() page="issue" op="current"}" class="action">{translate key="site.journalCurrent"}</a> | <a href="{url journal=$journal->getPath() page="user" op="register"}" class="action">{translate key="site.journalRegister"}</a>
