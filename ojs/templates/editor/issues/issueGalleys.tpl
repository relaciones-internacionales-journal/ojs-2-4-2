...
<div id="editor_top_menu">
	<ul class="nav nav-pills">
		...
		<li class="active"><a href="{url op="issueGalleys" path=$issueId}">{translate key="editor.issues.galleys"}</a></li>
...
<table width="100%" class="info">
	...
	<br />
	<span class="btn btn-file btn-small"><input type="file" name="galleyFile" id="galleyFile" size="10" class="uploadField" />{translate key="plugins.block.navigation.journalContent"}</span>
