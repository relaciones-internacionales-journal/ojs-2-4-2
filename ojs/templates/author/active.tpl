...
<table class="listing" width="100%">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="5%">{*<span class="disabled">{translate key="submission.date.mmdd"}</span><br />*}{sort_heading key="submissions.submitted" sort="submitDate"}</td>
...
{else}
	<tr>
		<td colspan="4" align="left" class="table_results_pagination">{page_info iterator=$submissions}</td>
		<td colspan="2" align="right" class="table_results_pagination">{page_links anchor="submissions" name="submissions" iterator=$submissions sort=$sort sortDirection=$sortDirection}</td>
	</tr>
{/if}
</table>
</div>
