...
{else}
	<tr>
		<td align="left" colspan="3" class="table_results_pagination">{page_info iterator=$submissions}</td>
		<td align="right" colspan="3" class="table_results_pagination">{page_links anchor="submissions" name="submissions" iterator=$submissions sort=$sort sortDirection=$sortDirection}</td>
	</tr>
{/if}
</table>
</div>
