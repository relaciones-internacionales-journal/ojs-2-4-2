...
<div id="author_submit_endSummary">
...
<tr valign="top">
	...
	<td>{$file->getDateUploaded()|date_format:$dateFormatShort}</td>
</tr>
{foreachelse}
<tr valign="top">
...
<p style="text-align:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-small" onclick="confirmAction('{url page="author"}', '{translate|escape:"jsparam" key="author.submit.cancelSubmission"}')" /> <input type="submit" value="{translate key="author.submit.finishSubmission"}" class="btn btn-small" /></p>
</div>
</form>
