...
<div id="author_submit_submissionSupportingAgencies">
...
<div id="author_submit_metaCitations">
...
<p style="text-align:right;"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger btn-small" onclick="confirmAction('{url page="author"}', '{translate|escape:"jsparam" key="author.submit.cancelSubmission"}')" /> <input type="submit" value="{translate key="common.saveAndContinue"}" class="btn btn-small" /></p>
