...
<form method="post" action="{url op="uploadLayoutFile"}"  enctype="multipart/form-data">
	...
	<label class="checkbox inline" for="layoutFileTypeSubmission"><input type="radio" name="layoutFileType" id="layoutFileTypeSubmission" value="submission" checked="checked" /> {translate key="submission.layout.layoutVersion"}</label>
	<label class="checkbox inline" for="layoutFileTypeGalley"><input type="radio" name="layoutFileType" id="layoutFileTypeGalley" value="galley" /> {translate key="submission.galley"}</label>
	<label class="checkbox inline" for="layoutFileTypeSupp"><input type="radio" name="layoutFileType" id="layoutFileTypeSupp" value="supp" /> {translate key="article.suppFilesAbbrev"}</label><br/><br/>
	<span class="btn btn-file btn-small"><input type="file" name="layoutFile" size="10" class="uploadField" />{translate key="plugins.block.navigation.journalContent"}</span>
	<input type="submit" value="{translate key="common.upload"}" class="btn btn-small" />
	<br /><br />
	<strong>{translate key="submission.createRemote"}:</strong><br/>
	<label class="checkbox inline" for="layoutFileTypeGalley"><input type="radio" name="layoutFileType" id="layoutFileTypeGalley" value="galley" /> {translate key="submission.galley"}</label>
	<label class="checkbox inline" for="layoutFileTypeSupp"><input type="radio" name="layoutFileType" id="layoutFileTypeSupp" value="supp" /> {translate key="article.suppFilesAbbrev"}</label>
	<input type="submit" name="createRemote" value="{translate key="common.create"}" class="btn btn-small" style="margin-left:10px;"/>
	</p>
</form>
...
&nbsp;&nbsp;
<a href="javascript:openHelp('{url op="instructions" path="layout"}')" class="action info_general">{translate key="submission.layout.instructions"}</a>
{/if}
{if $currentJournal->getSetting('provideRefLinkInstructions')}
&nbsp;&nbsp;
<a href="javascript:openHelp('{url op="instructions" path="referenceLinking"}')" class="action link_general">{translate key="submission.layout.referenceLinking"}</a>
{/if}
</div>
</div>
