...
<p style="text-align:right"><input type="button" value="{translate key="common.cancel"}" class="btn btn-danger" onclick="document.location.href='{url page="manager" escape=false}'" /> <input type="submit" value="{translate key="manager.people.enrollSelected"}" class="btn" /></p>
