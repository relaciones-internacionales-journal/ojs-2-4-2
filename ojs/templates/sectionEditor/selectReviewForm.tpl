...
{else}
	<tr>
		<td align="left" class="table_results_pagination">{page_info iterator=$reviewForms}</td>
		<td align="right" class="table_results_pagination">{page_links anchor="reviewForms" name="reviewForms" iterator=$reviewForms}</td>
	</tr>
{/if}
</table>
</div>
