...
<div id="editor_top_menu">
	<ul class="nav nav-pills">
		<li{if ($pageToDisplay == "submissionsInReview")} class="active"{/if}><a href="{url path="submissionsInReview"}">{translate key="common.queue.short.submissionsInReview"}</a></li>
		<li{if ($pageToDisplay == "submissionsInEditing")} class="active"{/if}><a href="{url path="submissionsInEditing"}">{translate key="common.queue.short.submissionsInEditing}</a></li>
		<li{if ($pageToDisplay == "submissionsArchives")} class="active"{/if}><a href="{url path="submissionsArchives"}">{translate key="common.queue.short.submissionsArchives"}</a></li>
	</ul>
</div>
<form action="#">
<ul class="filter">
