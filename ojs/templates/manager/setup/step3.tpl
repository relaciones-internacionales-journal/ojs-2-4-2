...
<div id="manager_authorGuidelinesInfo">
<h3>3.1 {translate key="manager.setup.authorGuidelines"}</h3>

<p>{translate key="manager.setup.authorGuidelinesDescription"}</p>

<p>
	<textarea name="authorGuidelines[{$formLocale|escape}]" id="authorGuidelines" rows="12" cols="60" class="textArea input-xxlarge">{$authorGuidelines[$formLocale]|escape}</textarea>
</p>

</div>

<div id="manager_submissionPreparationChecklist">
...
{foreach name=checklist from=$submissionChecklist[$formLocale] key=checklistId item=checklistItem}
	...
	<tr valign="top">
		<td width="5%" class="label"><input type="text" name="submissionChecklist[{$formLocale|escape}][{$checklistId|escape}][order]" value="{$checklistItem.order|escape}" size="3" maxlength="2" class="textField input-mini" /></td>
		<td class="value"><textarea name="submissionChecklist[{$formLocale|escape}][{$checklistId|escape}][content]" id="submissionChecklist-{$checklistId|escape}" rows="3" cols="40" class="textArea input-xxlarge">{$checklistItem.content|escape}</textarea></td>	
	</tr>
	
	<tr valign="top">
		<td class="label">&nbsp;</td>
		<td width="100%"><input type="submit" name="delChecklist[{$checklistId|escape}]" value="{translate key="common.delete"}" class="btn btn-danger btn-small" /></td>
{/foreach}
...
<p><input type="submit" name="addChecklist" value="{translate key="manager.setup.addChecklistItem"}" class="btn btn-small" /></p>
</div>

<div class="separator"></div>

<div id="manager_authorCopyrightNotice">
...
<p><textarea name="copyrightNotice[{$formLocale|escape}]" id="copyrightNotice" rows="12" cols="60" class="textArea input-xxlarge">{$copyrightNotice[$formLocale]|escape}</textarea></p>
...
<div id="manager_competingInterests">
...
<p><textarea name="competingInterestGuidelines[{$formLocale|escape}]" id="competingInterestGuidelines" rows="12" cols="60" class="textArea input-xxlarge">{$competingInterestGuidelines[$formLocale]|escape}</textarea></p>
</div>

<div class="separator"></div>

<div id="manager_forAuthorsToIndexTheirWork">
...
<table width="100%" class="data_alt">
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="text" name="metaDisciplineExamples[{$formLocale|escape}]" id="metaDisciplineExamples" value="{$metaDisciplineExamples[$formLocale]|escape}" size="60" maxlength="255" class="textField input-xlarge" />
			<br />
		...
		<td class="value">
			<table width="100%">
				<tr valign="top">
					...
					<td width="90%"><input type="text" name="metaSubjectClassTitle[{$formLocale|escape}]" id="metaSubjectClassTitle" value="{$metaSubjectClassTitle[$formLocale]|escape}" size="40" maxlength="255" class="textField input-xlarge" /></td>
				</tr>
				<tr valign="top">
					<td width="10%">{fieldLabel name="metaSubjectClassUrl" key="common.url"}</td>
					<td width="90%"><input type="text" name="metaSubjectClassUrl[{$formLocale|escape}]" id="metaSubjectClassUrl" value="{$metaSubjectClassUrl[$formLocale]|escape}" size="40" maxlength="255" class="textField input-xlarge" /></td>
				</tr>
			</table>
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="text" name="metaSubjectExamples[{$formLocale|escape}]" id="metaSubjectExamples" value="{$metaSubjectExamples[$formLocale]|escape}" size="60" maxlength="255" class="textField input-xlarge" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="text" name="metaCoverageGeoExamples[{$formLocale|escape}]" id="metaCoverageGeoExamples" value="{$metaCoverageGeoExamples[$formLocale]|escape}" size="60" maxlength="255" class="textField input-xlarge" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="text" name="metaCoverageChronExamples[{$formLocale|escape}]" id="metaCoverageChronExamples" value="{$metaCoverageChronExamples[$formLocale]|escape}" size="60" maxlength="255" class="textField input-xlarge" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="text" name="metaCoverageResearchSampleExamples[{$formLocale|escape}]" id="metaCoverageResearchSampleExamples" value="{$metaCoverageResearchSampleExamples[$formLocale]|escape}" size="60" maxlength="255" class="textField input-xlarge" />
			<br />
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="text" name="metaTypeExamples[{$formLocale|escape}]" id="metaTypeExamples" value="{$metaTypeExamples[$formLocale]|escape}" size="60" maxlength="255" class="textField input-xlarge" />
			<br />
...
<div id="manager_registerJournalForIndexing">
...
<table width="100%" class="data_alt">
	...
	<tr valign="top">
		...
		<td class="value">{fieldLabel name="copySubmissionAckAddress" key="manager.setup.notifications.copySpecifiedAddress"}&nbsp;&nbsp;<input {if !$submissionAckEnabled}disabled="disabled" {/if}type="text" class="textField input-xlarge" id="copySubmissionAckAddress" name="copySubmissionAckAddress" value="{$copySubmissionAckAddress|escape}"/></td>
	</tr>
...
<div id="manager_citationAssistant">
