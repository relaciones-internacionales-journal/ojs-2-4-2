...
<table width="100%" class="data_alt">
	...
	<tr valign="top">
		<td class="label"><label class="checkbox" for="statNumPublishedIssues"><input type="checkbox" id="statNumPublishedIssues" name="statNumPublishedIssues" {if $statNumPublishedIssues}checked="checked" {/if}/>{translate key="manager.statistics.statistics.numIssues"}</label></td>
		<td colspan="2" class="value">{$issueStatistics.numPublishedIssues}</td>
	</tr>

	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statItemsPublished"><input type="checkbox" id="statItemsPublished" name="statItemsPublished" {if $statItemsPublished}checked="checked" {/if}/>{translate key="manager.statistics.statistics.itemsPublished"}</label></td>
		<td width="80%" colspan="2" class="value">{$articleStatistics.numPublishedSubmissions}</td>
	</tr>
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statNumSubmissions"><input type="checkbox" id="statNumSubmissions" name="statNumSubmissions" {if $statNumSubmissions}checked="checked" {/if}/>{translate key="manager.statistics.statistics.numSubmissions"}</label></td>
		<td width="80%" colspan="2" class="value">{$articleStatistics.numSubmissions}</td>
	</tr>
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statPeerReviewed"><input type="checkbox" id="statPeerReviewed" name="statPeerReviewed" {if $statPeerReviewed}checked="checked" {/if}/>{translate key="manager.statistics.statistics.peerReviewed"}</label></td>
		<td width="80%" colspan="2" class="value">{$limitedArticleStatistics.numReviewedSubmissions}</td>
	</tr>
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statCountAccept"><input type="checkbox" id="statCountAccept" name="statCountAccept" {if $statCountAccept}checked="checked" {/if}/>&nbsp;&nbsp;{translate key="manager.statistics.statistics.count.accept"}</label></td>
	...
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statCountDecline"><input type="checkbox" id="statCountDecline" name="statCountDecline" {if $statCountDecline}checked="checked" {/if}/>&nbsp;&nbsp;{translate key="manager.statistics.statistics.count.decline"}</label></td>
	...
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statDaysPerReview"><input type="checkbox" id="statDaysPerReview" name="statDaysPerReview" {if $statDaysPerReview}checked="checked" {/if}/>&nbsp;&nbsp;{translate key="manager.statistics.statistics.daysPerReview"}</label></td>
	...
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statDaysToPublication"><input type="checkbox" id="statDaysToPublication" name="statDaysToPublication" {if $statDaysToPublication}checked="checked" {/if}/>&nbsp;&nbsp;{translate key="manager.statistics.statistics.daysToPublication"}</label></td>
		<td colspan="2" class="value">{$limitedArticleStatistics.daysToPublication}</td>
	</tr>
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statRegisteredUsers"><input type="checkbox" id="statRegisteredUsers" name="statRegisteredUsers" {if $statRegisteredUsers}checked="checked" {/if}/>{translate key="manager.statistics.statistics.registeredUsers"}</label></td>
	...
	<tr valign="top">
		<td width="20%" class="label"><label class="checkbox" for="statRegisteredReaders"><input type="checkbox" id="statRegisteredReaders" name="statRegisteredReaders" {if $statRegisteredReaders}checked="checked" {/if}/>{translate key="manager.statistics.statistics.registeredReaders"}</label></td>
	...
	<tr valign="top">
		<td width="20%" colspan="3" class="label"><label class="checkbox" for="statViews"><input type="checkbox" id="statViews" name="statViews" {if $statViews}checked="checked" {/if}/>{translate key="manager.statistics.statistics.articleViews"}</label></td>
	</tr>
</table>
<p>{translate key="manager.statistics.statistics.note"}</p>

{translate key="manager.statistics.statistics.makePublic"}<br/>
<input type="submit" class="btn btn-small" value="{translate key="common.record"}"/>
</form>
</div>
