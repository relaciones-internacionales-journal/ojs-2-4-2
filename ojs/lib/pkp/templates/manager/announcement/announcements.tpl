...
{else}
	<tr>
		<td colspan="2" align="left" class="table_results_pagination">{page_info iterator=$announcements}</td>
		<td colspan="2" align="right" class="table_results_pagination">{page_links anchor="announcements" name="announcements" iterator=$announcements}</td>
	</tr>
{/if}
</table>

<a href="{url op="createAnnouncement"}" class="action crear_general">{translate key="manager.announcements.create"}</a>
</div>
